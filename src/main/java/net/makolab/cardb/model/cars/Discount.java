...
public class Discount {
    ...
    @JsonProperty("ApplicableToPrice")
    private String applicableToPrice;
    @JsonProperty("ApplicableToSection")
    private String applicableToSection;
    @JsonProperty("CustomerOptInRequired")
    private Boolean customerOptInRequired;
    ...
    @JsonProperty("ApplicableToPrice")
    public String getApplicableToPrice() {
        return applicableToPrice;
    }

    @JsonProperty("ApplicableToPrice")
    public void setApplicableToPrice(String applicableToPrice) {
        this.applicableToPrice = applicableToPrice;
    }

    @JsonProperty("ApplicableToSection")
    public String getApplicableToSection() {
        return applicableToSection;
    }

    @JsonProperty("ApplicableToSection")
    public void setApplicableToSection(String applicableToSection) {
        this.applicableToSection = applicableToSection;
    }

    @JsonProperty("CustomerOptInRequired")
    public Boolean getCustomerOptInRequired() {
        return customerOptInRequired;
    }

    @JsonProperty("CustomerOptInRequired")
    public void setCustomerOptInRequired(Boolean customerOptInRequired) {
        this.customerOptInRequired = customerOptInRequired;
    }
